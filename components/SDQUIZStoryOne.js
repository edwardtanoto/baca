...
const quiz = [
  {
    correctoption: 'Eating',
    options: ['Sight', 'Hearing', 'Eating', 'Touch ', 'Taste'],
    question: 'WHAT’S not included in 5 human sense?',
  },
  {
    correctoption: 'Animal is a creature living in the zoo.',
    options: [
      'Animal is a creature living in the zoo.',
      'Food. Wait thats dark',
      'Pokemon without skills.',
    ],
    question: 'Other than human, animal also have 5 senses. What is an animal?',
  },
  {
    correctoption: 'Doggo',
    options: ['Stone', 'iPad', 'Doggo'],
    question: 'Give us example of animal',
  },
];
const SDQUIZStoryOne = ({ navigation, qno }) => {

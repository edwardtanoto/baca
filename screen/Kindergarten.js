  ...
  return(
    <ScrollView style = {styles.container}>
      ...
      <View style = {styles.buttonContainer}>
        <View>
          <TouchableOpacity onPress={navigation.navigate.bind(this,'Home')} style={styles.button1}>
            <Icon name = 'md-home' size={30}/>
          </TouchableOpacity>
          <Text style = {styles.buttonText}>Home</Text>
        </View>
        <View>
          <TouchableOpacity onPress={navigation.navigate.bind(this,'TK')} style={{...styles.button1,backgroundColor:'#cedbd4'}}>
      ...
      <View style={styles.levelContainer}>
        <View>
          ...
          <View style= {styles.circle}><Icon name = 'md-paper-plane' size={18}/></View>
            <View>
              <Text style={styles.title}>Story 1</Text>
              <ProgressBar progress={1} style={styles.progress} color={Colors.green800} />  
            </View>
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity style = {styles.story}>
            <View style= {styles.circle}><Icon name = 'md-checkbox-outline' size={18}/></View>
            <View>
              <Text style={styles.title}>Quiz 1</Text>
              <ProgressBar progress={0.9} style={styles.progress} color={Colors.green800} />
            </View>
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity style = {styles.story}>
            ...
            <View>
              ...
              <ProgressBar progress={0.5} style={styles.progress} color={Colors.green800} />
            </View>
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity style = {styles.story}>
            ...
            <View>
              ...
              <ProgressBar progress={0.1} style={styles.progress} color={Colors.green800} />
            </View>
          </TouchableOpacity>
        </View>
        <View>

...
import SDQUIZStoryOne from './../components/SDQUIZStoryOne';
const SDQUIZONE = ({ route, navigation }) => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {isQuizFinished ? (
        ...
        <SDQUIZStoryOne qno={initQno} navigation={navigation} />
      )}
    </View>
  );
};

export default SDQUIZONE;
